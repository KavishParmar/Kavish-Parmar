...
export default function Pricing() {
    ...
    return (
        <section id="pricing" className="py-16 sm:py-20 bg-background-gray">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-4">
                    {pricingPackages.map((pkg, index) => (
                        <div
                            key={index}
                            className={`relative p-6 sm:p-8 rounded-2xl bg-white shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-2 flex flex-col ${pkg.featured ? 'border-accent ring-2 ring-accent/20' : 'border-transparent'
                                }`}
                        >
                            {pkg.featured && (
                ...
                <div className="mt-12 sm:mt-16 text-center">
                    <div className="inline-block bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-secondary/10 max-w-2xl w-full">
                        <h3 className="text-xl sm:text-2xl font-heading font-bold text-primary mb-6">
