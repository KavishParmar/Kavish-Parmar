                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="website-only">Website Only - $499</option>
                                <option value="ai-chatbot">AI Chatbot - $299</option>
                                <option value="website-chatbot-combo">Website + Chatbot Combo - $699</option>
                            </select>
                        </div>
